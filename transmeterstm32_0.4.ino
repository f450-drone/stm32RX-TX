...
void loop() {
  ...
  data.throttle = mapJoystickValues(analogRead(PA0), 12, 1075, 2048, true);
  data.yaw = mapJoystickValues(analogRead(PA1), 12, 1070, 2048, false);
  data.pitch = mapJoystickValues(analogRead(PA2), 12, 1095, 2048, false);
  data.roll = mapJoystickValues(analogRead(PA3), 12, 1058,  2048, true);
