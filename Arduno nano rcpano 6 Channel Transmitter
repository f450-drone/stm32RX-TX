  ...
  void loop()
{
  ...
  data.throttle = mapJoystickValues( analogRead(A0), 250, 540, 600, true );  //120 potentiometer "true" or "false" for signal direction | "true" veya "false" sinyal yönünü belirler
  ...
  data.yaw = mapJoystickValues( analogRead(A1), 250, 540, 600, false );       // "true" or "false" for servo direction | "true" veya "false" servo yönünü belirler
